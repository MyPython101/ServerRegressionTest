...
- Unit Testing usually perform by developer.
- Not only test if a unit (collection of statements: statements, function, block, object) is working but what happen (to the system/ mock object use case) when it is not working.
...
- Most use class/interface:
  - TestSuite class: test suites
  - UnitTestCase class: unit test case
  - Mock class: generate mock object

## UnitTestCases class
- implement SimpleTest framework (for unit testing) by extend the UnitTestCase class of SimpleTest framework. 
- This class of test case includes standard tests for equality, references and pattern matching
- UnitTestCases class belong to the 'simpletest/autorun.php'

## UnitTestCase Class
Some functions of 'UnitTestCase' class:
```php
