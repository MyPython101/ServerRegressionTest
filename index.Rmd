...
## SimpleTest: Testing Client and Server Side

- Client Side: SimpleTest Allows testing code execution on the client, such as a web browser which is focusing on PHP tasks, such as logging into a site
- Server side: Server-side behavior can be tested by writing simple unit tests to test functionality and behavior of single components.(7)
